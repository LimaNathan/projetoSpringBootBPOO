...
public class Product extends NamedEnity {
    ...
    @JoinTable(name = "PRODUCT_CATEGORY",
                joinColumns = @JoinColumn(name = "product_id"), //descrevendo como será no banco de dados
                inverseJoinColumns = @JoinColumn(name = "category_id")) //criando um relacioamento entre product_id e category_id
